...
@section('title', 'Thêm bài tập Part4')
@section('content')
<div class="card shadow mb-4">
    <div class="card-header py-3 d-flex justify-content-between">
        <a href="{{ route('list-part4') }}">
            <i class="fas fa-fw fa-arrow-left"></i>
            Danh sách bài tập Part 4
        </a>
    </div>
    <div class="card-body">
        <h4 class="mb-4 font-weight-bold text-primary">Thêm mới bài tập Part 4</h4>
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label>File âm thanh (10 files)<span class="text-danger">*</span></label>
            ...
            <div class="form-group">
                <label>File hình ảnh (2 files)<span class="text-danger">*</span></label></label>

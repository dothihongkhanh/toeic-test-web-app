...
<div class="card shadow mb-4">
    <div class="card-header py-3 d-flex justify-content-between">
        <h6 class="m-0 font-weight-bold text-primary">Danh sách bài tập Part 6</h6>
        <a href="/admin/reading/create-part6" class="btn btn-primary">
            <i class="fas fa-upload fa-sm text-white-50"></i>
            <span>Tải lên file Part 6</span>
        </a>
    </div>
    <div class="card-body">
            ...
            <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $exam->price }}</td>
                        <td>
                            <a href="/admin/reading/detail-part6/{{ $exam->id }}" class="btn btn-warning">Chi tiết</a>

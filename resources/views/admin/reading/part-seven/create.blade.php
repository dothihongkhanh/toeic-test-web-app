...
@section('title', 'Thêm bài tập Part7')
@section('content')
<div class="card shadow mb-4">
    <div class="card-header py-3 d-flex justify-content-between">
        <a href="/admin/reading/list-part7">
            <i class="fas fa-fw fa-arrow-left"></i>
            Danh sách bài tập Part 7
        </a>
    </div>
    <div class="card-body">
        <h4 class="mb-4 font-weight-bold text-primary">Thêm mới bài tập Part 7</h4>
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label>Nội dung câu hỏi (File excel - 54 câu hỏi)<span class="text-danger">*</span></label>
            ...
            <div class="form-group">
                <label>File hình ảnh (23 files)<span class="text-danger">*</span></label></label>

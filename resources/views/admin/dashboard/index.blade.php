...
<div class="card shadow mb-4">
    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
        <h6 class="m-0 font-weight-bold text-primary">Số lượt luyện tập</h6>
    </div>
    <div class="card-body">
        <div class="chart-area m-auto" style="width: 600px">
            <canvas id="examsChart" width="80" height="40"></canvas>

...
@section('title', config('app.name'). ' - Part 6')
@section('content')
    ...
    <div class="container">
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex">
                ...
                <p class="m-0 font-weight-bold text-primary">PART 6</p>
            </div>
            @if (!$examsInPart6->isEmpty())
            <div class="card-body">
                ...
                <div class="card shadow mb-4">
                    <div class="card-body d-flex align-items-center">
                        ...
                        <div class="ml-auto d-flex">
                            ...
                            @else
                            <a href="/practice-reading/part6/detail/{{ $exam->id }}" class="btn btn-primary">Bắt đầu</a>
                            @endif
                            <a href="/practice-reading/history/{{ $exam->id }}" class="btn btn-outline-primary ml-2">Xem lịch sử</a>
                        </div>
                    </div>
                </div>
                @endforeach
